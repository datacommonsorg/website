...
#                      summary_column_name='summary') -> Dict:
...
# def process_tsv(tsv_path: str,
#                 output_path: str,
#                 place_column_name='dcid',
#                 summary_column_name='summary') -> None:
#   """Convert tsv to a summary json file"""
