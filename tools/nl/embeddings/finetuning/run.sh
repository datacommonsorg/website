...
if [ "$2" != "" ]; then
  ...
  INTERMEDIATE_FINETUNED_MODEL=$(curl -s https://raw.githubusercontent.com/datacommonsorg/website/master/deploy/base/models.yaml | awk '$1=="tuned_model:"{ print $2; }' | cut -f2- -d'.')
fi
