...
- For the apikey, you can go to the [Apigee UI](https://pantheon.corp.google.com/apigee/apiproducts/product/datacommons-nl-api?project=datcom-apigee) and either find or create a key associated with an app that is enabled for the product `datacommons-nl-api`. See the [Apigee docs](https://cloud.google.com/apigee/docs/api-platform/security/api-keys) for guidance.
