...
class TextFormatTest(unittest.TestCase):
    ...
    @parameterized.expand([
        ...
        ('dollar6', 'USDollar2000000Onwards', 'USDollar',
         'More than 2,000,000 $'), ('room1', 'Rooms1', 'Rooms', '1 Rooms'),
    ...
    node1 = {
        "sv": "Count_Person_EnrolledInPrivateSchool",
        "l": "Private School"
    }
    node2 = {
        "sv": "Count_Person_3OrMoreYears_Female_EnrolledInPublicSchool",
        "l": "Public School"
    }
    sorted1 = [node1, node2]

    node3 = {
        "sv": "Count_Person_Upto5Years_Female_HispanicOrLatino",
        "l": "Hispanic Or Latino"
    }
    node4 = {
        "sv": "Count_Person_Upto5Years_Female_BlackOrAfricanAmericanAlone",
        "l": "Not in List"
    }
