...
def merge_messages(default_messages: BundleDict, lang_messages: BundleDict) -> Tuple[int, BundleDict]:
    added_count = 0
...
def main():
    ...
    added_count, locale_messages = merge_messages(default_messages, locale_messages)
