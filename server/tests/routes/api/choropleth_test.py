...
class TestGetGeoJson(unittest.TestCase):
  ...
  @patch('server.routes.shared_api.choropleth.lib_util.property_values')
...
class TestChoroplethData(unittest.TestCase):
  ...
  @patch('server.routes.shared_api.choropleth.dc.get_places_in')
  @patch('server.routes.shared_api.choropleth.lib_util.point_within_core')
  @patch('server.routes.shared_api.choropleth.lib_util.series_core')
  @patch('server.routes.shared_api.choropleth.get_choropleth_display_level')
