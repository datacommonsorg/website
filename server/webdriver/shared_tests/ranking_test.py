...
class RankingTestMixin():
  ...
  def test_northamerica_population(self):
    ...
    percy_snapshot(self.driver,
                   self.dc_title_string + ' Ranking North America Population')
  ...
  def test_population_bottom_ranking_hi(self):
    ...
    percy_snapshot(self.driver,
                   self.dc_title_string + ' Ranking India Population Bottom')
  ...
  def test_population_top_ranking_ko(self):
    ...
    percy_snapshot(self.driver,
                   self.dc_title_string + ' Ranking Korea Population Top')
