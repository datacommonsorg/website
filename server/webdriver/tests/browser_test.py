...
class TestBrowser(WebdriverBaseTest):
  ...
  def test_page_serve_mtv(self):
    ...
    TITLE_TEXT = "Mountain View - Knowledge Graph Browser - Data Commons"
  ...
  def test_page_serve_ca_population(self):
    ...
    TITLE_TEXT = "Count_Person - California - Knowledge Graph Browser - Data Commons"
  ...
  def test_page_serve_austrobaileya(self):
    ...
    TITLE_TEXT = "Austrobaileya scandens C.T.White - Knowledge Graph Browser - Data Commons"
  ...
  def test_observation_table_redirect(self):
    ...
    NEW_PAGE_TITLE = 'dc/o/y54f4zvqrzf67 - Knowledge Graph Browser - Data Commons'
    WebDriverWait(self.driver,
