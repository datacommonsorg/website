...
class TestCharts(WebdriverBaseTest):
    ...
    def test_check_statvar_and_uncheck(self):
        ...
        # Re-store a list of all the charts.
        charts = self.driver.find_elements_by_css_selector(".card")
    ...
    def test_place_search_box_and_remove_place(self):
        ...
        first_result = self.driver.find_elements_by_class_name("pac-item")[0]
        first_result.click()
        ...
        # Wait until the line element within the card is present.
        element_present = EC.presence_of_element_located(
            (By.CSS_SELECTOR, '.line:nth-child(even)'))
        WebDriverWait(self.driver, SLEEP_SEC).until(element_present)
        ...
        # Re-store a list of all the charts and lines.
        charts = self.driver.find_elements_by_class_name("card")
        lines = charts[0].find_elements_by_class_name("line")
