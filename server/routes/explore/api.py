...
def detect_and_fulfill():
  ...
  utterance.prev_utterance = None
  data_dict[Params.CTX.value] = serialize.save_utterance(utterance)
  data_dict[Params.ENABLE_NL_FULFILLMENT] = request.get_json().get(Params.ENABLE_NL_FULFILLMENT, "")
  data_dict[Params.EXP_MORE_DISABLED] = request.get_json().get(Params.EXP_MORE_DISABLED, "")
  data_dict[Params.DC] = request.get_json().get(Params.DC, "")
