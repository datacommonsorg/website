...
_PAGEMETADATA_CONTAINEDPLACETYPESENTRY = _PAGEMETADATA.nested_types_by_name[
    'ContainedPlaceTypesEntry']
_PAGEMETADATA_EVENTTYPESPECENTRY = _PAGEMETADATA.nested_types_by_name[
    'EventTypeSpecEntry']
...
_DISASTEREVENTMAPTILESPEC = DESCRIPTOR.message_types_by_name[
...
EventTypeSpec = _reflection.GeneratedProtocolMessageType(
    'EventTypeSpec',
    (_message.Message,),
    {
...
PageMetadata = _reflection.GeneratedProtocolMessageType(
    'PageMetadata',
    (_message.Message,),
    {
        'ContainedPlaceTypesEntry':
...
StatVarSpec = _reflection.GeneratedProtocolMessageType(
    'StatVarSpec',
    (_message.Message,),
    {
...
RankingTileSpec = _reflection.GeneratedProtocolMessageType(
    'RankingTileSpec',
    (_message.Message,),
    {
...
DisasterEventMapTileSpec = _reflection.GeneratedProtocolMessageType(
    'DisasterEventMapTileSpec',
    (_message.Message,),
    {
...
SubjectPageConfig = _reflection.GeneratedProtocolMessageType(
    'SubjectPageConfig',
    (_message.Message,),
    {
