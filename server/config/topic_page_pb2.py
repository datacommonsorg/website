...
_PAGEMETADATA_CONTAINEDPLACETYPESENTRY.has_options = True
_PAGEMETADATA_CONTAINEDPLACETYPESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_TILE_CONTAINEDPLACETYPESENTRY.has_options = True
_TILE_CONTAINEDPLACETYPESENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
_CATEGORY_STATVARMETADATAENTRY.has_options = True
_CATEGORY_STATVARMETADATAENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
