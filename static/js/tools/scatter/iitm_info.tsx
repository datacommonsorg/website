   ...
   return (
     <div id="placeholder-container">
       ...
       <ul>
         ...
         <li>
           <b>
             Count of Urban Households vs Rural Households
           </b>{" "}
           among{" "}
           <a
             href={
         ...
         <li>
           <b>Worker Population vs Female Literate Population</b>{" "}
           among{" "}
           <a
             href={
         ...
         <li>
           <b>Number of Schools vs Dropout Rate of Female Students</b>{" "}
           among{" "}
           <a
             href={
