...
interface ReminderProps extends React.SVGProps<SVGSVGElement> {
  // Whether to use the "filled" version of the icon
  // when true, equivalent to setting the FILL axis of material symbols to 1
