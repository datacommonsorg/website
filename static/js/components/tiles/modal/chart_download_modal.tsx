...
interface ChartDownloadModalPropsType {
  container?: HTMLElement;
}

interface ChartDownloadModalStateType {
  modal: boolean;
  svgXml: string;
  dataCsv: string;
  chartDate: string;
 ...
 *                 modals.
 */
class ChartDownloadModal extends React.Component<
  ChartDownloadModalPropsType,
  ChartDownloadModalStateType
> {
  ...
  /**
   * Updates the view state of the modal to true, and includes the data
   * necessary for displaying the modal.
   */
  public show(
    svgXml: string,
    getDataCsv: () => Promise<string>,
  ...
  /**
   * Decorates chartHtml with title and provenance information embeded in an
   * enclosing SVG node. Returns the SVG contents as a string.
   */
  ...
  /**
   * Decorates svgXml with title and provenance information embeded in an
   * enclosing SVG node. Returns the SVG contents as a string.
   */
