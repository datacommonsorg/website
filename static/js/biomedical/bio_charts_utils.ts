...
export const TOOL_TIP = d3.select("#main").append("div").attr("class", "tooltip");
...
export type Datum = | DiseaseGeneAssociationData | ProteinNumData | ProteinNode | InteractionLink | DiseaseAssociationType;
/**
