...
export const TIMELINE_URL_PARAM_MAPPING: Record<string, string> = {
  ...
  [URL_PARAMS.DISPLAY]: "",
  [STAT_VAR_PARAM_KEYS.DCID]: "",
  [STAT_VAR_PARAM_KEYS.PER_CAPITA]: "",
  [STAT_VAR_PARAM_KEYS.LOG]: "",
  [STAT_VAR_PARAM_KEYS.DATE]: "",
  [STAT_VAR_PARAM_KEYS.DENOM]: "denom",
};
...
export const MAP_URL_PARAM_MAPPING: Record<string, string> = {
  ...
  [URL_PARAMS.DISPLAY]: "",
  [STAT_VAR_PARAM_KEYS.DCID]: "",
  [STAT_VAR_PARAM_KEYS.PER_CAPITA]: "pg",
  [STAT_VAR_PARAM_KEYS.LOG]: "",
  [STAT_VAR_PARAM_KEYS.DATE]: "",
  [STAT_VAR_PARAM_KEYS.DENOM]: "",
  [DISPLAY_PARAM_KEYS.SCATTER_QUADRANTS]: "",
  [DISPLAY_PARAM_KEYS.SCATTER_LABELS]: "",
};

export const SCATTER_URL_PARAM_MAPPING: Record<string, string> = {
  [URL_PARAMS.PLACE]: "place",
  [URL_PARAMS.ENCLOSED_PLACE_TYPE]: "",
  [URL_PARAMS.STAT_VAR]: statsVar",
  [URL_PARAMS.DISPLAY]: "",
