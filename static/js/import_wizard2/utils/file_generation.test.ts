...
test("shouldGenerateCsv", () => {
  ...
  const cases: {
    ...
    {
      name: "first data row is not second row",
      originalCsv: {
        ...baseCsvData,
        orderedColumns: [columnSameHeaderId1, columnSameHeaderId2],
        firstDataRow: 3,
    ...
    {
      name: "last data row is not the last row in the file",
      originalCsv: {
        ...baseCsvData,
        orderedColumns: [columnSameHeaderId1, columnSameHeaderId2],
        lastDataRow: 3,
...
test("generateCsvDiffHeaderAndDataRows", () => {
  // column at idx 0 where header and id are the same
  const columnSameHeaderId1 = {
    id: "header",
    header: "header",
