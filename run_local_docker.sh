...
./run_local_docker.sh --actions build --image my-datacommons:dev
...
./run_local_docker.sh --actions build_run --image my-datacommons:dev --container service
...
./run_local_docker.sh --actions build_upload --image my-datacommons:dev
