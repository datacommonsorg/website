...
#
def download_file(bucket: str, filename: str, use_anonymous_client: bool = False) -> str:
  storage_client = storage.Client.create_anonymous_client() if use_anonymous_client else storage.Client()
