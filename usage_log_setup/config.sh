...
export DESTINATION_PROJECT_ID="datcom-website-autopush"
...
export SCHEDULED_QUERY_NAME="test script scheduled query new new new"
# The file in this directory that contains the SQL query that aggregates the logs into daily summaries
export SQL_FILE="./usage_log_setup/aggregation_query copy.sql"
